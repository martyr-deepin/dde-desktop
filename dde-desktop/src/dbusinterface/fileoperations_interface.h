 ...
 * Command line was: qdbusxml2cpp -N -p fileoperations_interface.h:fileoperations_interface.cpp -c FileOperationsInterface fileoperations.xml
 *
...
#ifndef FILEOPERATIONS_INTERFACE_H_1436256435
#define FILEOPERATIONS_INTERFACE_H_1436256435
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QString, QDBusObjectPath, QString> NewGetLaunchAppJob(const QString &in0)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(in0);
        return asyncCallWithArgumentList(QStringLiteral("NewGetLaunchAppJob"), argumentList);
    }
    inline QDBusReply<QString> NewGetLaunchAppJob(const QString &in0, QDBusObjectPath &out1, QString &out2)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(in0);
